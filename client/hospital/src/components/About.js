...
function About () {
    ...
    <div className="about-us-container">
      ...
      <section className="section-vision">
        <h2>OUR VISSION</h2>
        <p>
          Our vision is to be the healthcare provider of choice, recognized for excellence in patient care, medical innovation, and community impact. We aspire to create a healthier future for our community by fostering a culture of collaboration, compassion, and continuous improvement.
        </p>
      </section>
      ...
      <section className="section-team">
        <h2>MEET OUR TEAM</h2>
        <p>
          Our team consists of skilled and dedicated healthcare professionals committed to delivering the highest quality care to our patients. From our experienced physicians and nurses to our support staff and administrators, every member of our team plays a vital role in providing exceptional healthcare services.
        </p>
      </section>
